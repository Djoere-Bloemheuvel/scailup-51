...
async function createTestLead() {
  console.log('🔧 Creating test lead with frontend-compatible columns...\n');
  ...
  try {
    ...
    // Create test lead with columns that the frontend expects
    const testLead = {
      user_id: userId,
      first_name: 'John',
      last_name: 'Doe',
      job_title: 'CEO',
      company_name: 'Test Company 1', // Frontend uses company_name, not company
    ...
    if (insertError) {
      ...
      const minimalLead = {
        ...
        first_name: 'Jane',
        last_name: 'Smith',
        company_name: 'Test Company 2', // Use company_name
...
async function main() {
  console.log('🚀 Starting test lead creation with frontend-compatible columns...\n');
