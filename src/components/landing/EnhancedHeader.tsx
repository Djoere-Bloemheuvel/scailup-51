...
export function EnhancedHeader() {
  ...
  const handleStartFreeClick = (e: React.MouseEvent) => {
    e.preventDefault();
    e.stopPropagation();
    console.log('=== ENHANCED HEADER CTA CLICKED ===');
    console.log('EnhancedHeader: Start Free button clicked - opening rebuilt modal');
    openModal();
    console.log('=== ENHANCED HEADER CTA COMPLETED ===');
  };

  const handleMobileStartFreeClick = (e: React.MouseEvent) => {
    e.preventDefault();
    e.stopPropagation();
    console.log('=== ENHANCED HEADER MOBILE CTA CLICKED ===');
    console.log('EnhancedHeader Mobile: Start Free button clicked - opening rebuilt modal');
    openModal();
    setIsMenuOpen(false);
    console.log('=== ENHANCED HEADER MOBILE CTA COMPLETED ===');
  };
