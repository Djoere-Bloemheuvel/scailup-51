-- Remove individual webhooks from bulk conversion function
-- This ensures only the frontend sends batch webhooks for performance control
-- Maintain Lovable compatibility

-- Update bulk conversion function to NOT send individual webhooks
...
BEGIN
  ...
  -- NO WEBHOOKS SENT HERE - Frontend will handle batch webhook
  RAISE NOTICE 'Bulk conversion completed: % successful, % failed. Frontend will send batch webhook.', success_count, failed_count;
