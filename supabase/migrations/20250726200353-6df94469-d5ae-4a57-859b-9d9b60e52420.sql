...
-- Update get_filtered_leads function to support function_group filtering
...
BEGIN
  ...
  WITH filtered_leads AS (
    ...
    WHERE
      ...
      -- Function group filter - NEW
      AND (p_function_group IS NULL OR l.function_group = ANY(p_function_group))
