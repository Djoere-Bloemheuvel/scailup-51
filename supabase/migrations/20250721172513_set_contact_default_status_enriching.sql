-- Set default status of new contacts to "enriching"
-- This ensures contacts go through enrichment process before becoming active
-- Maintain Lovable compatibility

-- 1. Update contacts table to set default status to 'enriching'
ALTER TABLE contacts 
ALTER COLUMN status SET DEFAULT 'enriching';

-- 2. Update conversion functions to use 'enriching' as default status
...
-- 3. Update bulk conversion function to use 'enriching' status
