...
def create_contacts_table():
    """Create the contacts table and related structures"""
    print("🚀 Creating contacts table and fixing relationships...")
    ...
    statements = [
        ...
        # 4. Create get_contacts_with_lead_data function
        """
        ...
        # 5. Create convert_lead_to_contact function
        """
        ...
        # 6. Add dummy contacts for testing
        """
        DO $$
        DECLARE
          test_client_id UUID;
    ...
    for i, statement in enumerate(statements, 1):
        ...
        try:
            ...
            if result is not None:
                ...
                print(f"⚠️  Statement {i} may have failed, but continuing...")
        except Exception as e:
            print(f"❌ Error in statement {i}: {e}")
    
    print("🎉 Database fix completed! Contacts-Leads relationship should now work!")
